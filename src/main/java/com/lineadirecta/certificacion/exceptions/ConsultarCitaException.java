...
public class ConsultarCitaException extends RuntimeException{

    private static final Severidad serialVersionUID = SEVERIDAD_MEDIA;

    private static final String ERROR = "Error al consultar la cita";

    public ConsultarCitaException(String mensaje, Throwable motivo){
